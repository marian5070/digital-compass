...
// TOATE rutele au slash final: e forma canonică servită (build de directoare +
// canonical din Astro.url + sitemap) — fără slash, fiecare link intern și
// hreflang trecea printr-un 301.
