---
title: "What NOT to put into AI tools (ChatGPT & co.)"
...
rules:
  ...
  - "Don't put in <strong>client data, contracts, passwords or financial data</strong>."
  - "Need help with an example? <strong>Remove the real data</strong> (anonymise) first."
  - "Use only the AI tools <strong>approved by your company</strong>; when in doubt, ask the IT team."
sources:
  - label: "DNSC (Romania's national cybersecurity agency) — data protection and online tools"
    url: "https://dnsc.ro"
---
