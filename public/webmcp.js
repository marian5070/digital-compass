    ...
    var tools = [
      {
        ...
        description:
          'Lista situațiilor de criză digitală acoperite de Digital Compass (link fals, cont spart, țeapă online...) plus ghidurile de prevenție. Folosește-o ca să găsești slug-ul potrivit pentru problema utilizatorului, apoi cheamă compass_continut.',
      ...
      },
      {
        ...
        description:
          'Conținutul complet (markdown) al unui playbook de criză sau ghid de prevenție: pașii de urmat acum, ce să NU faci, cum recunoști data viitoare, unde raportezi în România (DNSC 1911, Poliție, bancă), cu surse citate. Ghid public în română, limbaj simplu — potrivit de transmis direct utilizatorului.',
        inputSchema: {
          type: 'object',
          properties: {
        ...
        execute: function (args) {
          ...
          var base = a.tip === 'ghid' ? '/ghiduri/' : '/playbook/';
